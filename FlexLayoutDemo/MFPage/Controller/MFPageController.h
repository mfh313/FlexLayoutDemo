...
#define KSTATUSBARHEIGHT ([MFPageController iPhoneX]?44.0:20.0)
 ...
 *
 */
@interface MFPageController : UIViewController

@property (nonatomic, weak) id <MFPageControllerDelegate> delegate;
@property (nonatomic, weak) id <MFPageControllerDataSource> dataSource;
