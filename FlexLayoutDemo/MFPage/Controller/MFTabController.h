...
@interface MFTabController : UIViewController <MFPageControllerDataSource, MFPageControllerDelegate, MFTabDataSource, MFTabDelegate>
...
//自定义TABView,最好遵循MFTabDelegate，MFTabDataSource,要不有些情况要重写
