//
//  MFCoverViewControllerViewController.m
//  Radio
//
...
#import "MFCoverController.h"

@interface MFCoverController () <MFPageControllerDelegate>

@property (nonatomic, strong) UIView *__coverView;

@end

@implementation MFCoverController
